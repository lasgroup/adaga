...
class ExtendedScipyOptimizerInterface(tensorflow.contrib.opt.ScipyOptimizerInterface):
    """
    ...
    # List of the different optimization steps for theta and gamma
    optimization_record = []

    def record_optimization_step(self, x_opt: np.array) -> None:
        """
    ...
    def clean_optimization_record(self, n_params_theta: int,
                                  n_params_gamma: int,
        ...
        self.optimization_record_theta =\
            np.array(self.optimization_record_theta)
        self.optimization_record_states =\
            np.array(self.optimization_record_states)
        self.optimization_record_gamma =\
            np.array(self.optimization_record_gamma)
        return
